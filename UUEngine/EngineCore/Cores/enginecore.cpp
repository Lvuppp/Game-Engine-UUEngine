...
void EngineCore::createSimpleScene()
{
    ...
    m_sceneFolder->currentScene()->addGameObject("Golem", ModelType::CustomeModel, m_modelLoader.createModel(":/Models/TestModel/Stone.obj"), ":/Models/TestModel/Stone.obj");
    m_sceneFolder->currentScene()->addGameObject("Platform", ModelType::Cube, m_modelBuilder.createCube(20.0f, 1.0f, 20.0f));
    m_sceneFolder->currentScene()->addGameObject("Cube", ModelType::Cube, m_modelBuilder.createCube(0.5f, 0.5f, 0.5f));
    m_sceneFolder->currentScene()->setSkybox(m_modelBuilder.createSkybox(100.0f, ":/Textures/skybox3.png"));
